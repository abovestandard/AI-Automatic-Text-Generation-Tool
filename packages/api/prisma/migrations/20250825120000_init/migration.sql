...
CREATE TABLE "source_fields" (
    ...
    "send_as_image" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "source_fields" ADD CONSTRAINT "source_fields_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "source_fields" ADD CONSTRAINT "source_fields_prompt_id_fkey" FOREIGN KEY ("prompt_id") REFERENCES "prompts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
